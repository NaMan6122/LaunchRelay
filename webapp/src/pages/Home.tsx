...
import HD2DBackground from '../components/HD2DBackground'
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="code-block">
          <span className="tag">&lt;script</span> <span className="attr">src</span>=<span className="val">&quot;https://launchrelay.com/sdk/widget.js&quot;</span> <span className="attr">data-startup-id</span>=<span className="val">&quot;YOUR_ID&quot;</span> <span className="attr">async</span><span className="tag">&gt;&lt;/script&gt;</span>
        </div>
        ...
        <section className="section">
          ...
          <div className="widget-showcase">
            <div className="widget-demo">
              <div className="widget-demo-header">Bar — Fixed 48px strip</div>
            ...
            <div className="widget-demo">
              <div className="widget-demo-header">Badge — Corner circle</div>
              <div className="widget-demo-body">
                <p className="demo-placeholder-text">Your page content here...</p>
            ...
            <div className="widget-demo">
              <div className="widget-demo-header">Card — Inline content block</div>
              <div className="widget-demo-body">
                <p className="demo-placeholder-text">Your page content here...</p>
