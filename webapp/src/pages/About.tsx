      ...
      <AnimatedSection>
        <section className="section">
          ...
          <GlassCard>
            ...
            <p style={{ marginTop: 16 }}>There&apos;s a gap between &ldquo;zero visitors&rdquo; and &ldquo;enough traffic to validate a product&rdquo; — and nothing fills it cheaply.</p>
          </GlassCard>
        </section>
      </AnimatedSection>
      ...
      <AnimatedSection delay={100}>
        <section className="section">
          <div className="section-title">
            ...
            <p>Classic traffic exchanges failed because of quality collapse. LaunchRelay was built from day one to avoid that fate.</p>
          </div>
